...
const shareService = {
  ...
  // always windowed: the payload carries everything visible at any revealed moment
  getMap: (token, mapId, t) => api.get(`/${token}/maps/${mapId}`,
    { params: { ...(t != null ? { t } : {}), window: 1 } }).then((r) => r.data),
