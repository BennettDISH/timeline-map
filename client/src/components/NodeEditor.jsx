...
function NodeEditor({ 
  ...
  const [activeTab, setActiveTab] = useState('nodeType')
  ...
  // Tab configuration for expanded view
  const tabs = [
    { id: 'nodeType', label: 'Node Type', icon: '🏷️' },
    ...
    <div className={`node-editor ${isExpanded ? 'expanded' : 'condensed'}`}>
      ...
      <div className="editor-content">
        {isExpanded ? (
          ...
          // Condensed view with collapsible sections
          <>
            {/* Node Type Section */}
