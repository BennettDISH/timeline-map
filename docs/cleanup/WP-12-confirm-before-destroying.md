...
- [ ] **P012** · medium · m · Many destructive one-click controls skip both the confirm and the undo system (outline, period text, era, backdrops, image, link, voice line, share link, Forge Unmake)
- [ ] **P013** · medium · s · Regenerate and Turn off kill every player's link in one click with no confirmation and no feedback
- [ ] **P015** · medium · s · Small ✕ buttons delete a period's text or a link (with its label) at once, with no confirm and no undo
- [ ] **P050** · low · s · '✕ Remove outline' and '◌ Redraw' throw away a traced outline with no confirm and no Undo
- [ ] **P055** · low · s · Removing a timed backdrop or the base backdrop happens instantly, with no confirmation and no undo
- [ ] **P059** · low · s · Deleting an era is one click with no confirmation and no Undo
